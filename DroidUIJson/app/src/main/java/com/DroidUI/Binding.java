...
public class Binding<Value> {
    ...
    public Value getWrappedValue() { return location._value; }
    public void setWrappedValue(Value newValue) { location._value = newValue; }
    
    public Binding<Value> getProjectedValue() { return this; }
